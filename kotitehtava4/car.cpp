...
// Oletuskonstruktori
Car::Car() : objWheel1(), objWheel2(), objWheel3(), objWheel4(), model(""), brand("") {
...
void Car::printDetails() const {
    ...
    std::cout << "Moottori: " << objEngine.getHorsepower()
              << " hp, " << objEngine.getDisplacement() << " L\n";
    std::cout <<
               "  Rengas 1: " << objWheel1.getSize() << " tuumaa, " << objWheel1.getType() << "\n"
              << "  Rengas 2: " << objWheel2.getSize() << " tuumaa, " << objWheel2.getType() << "\n"
              << "  Rengas 3: " << objWheel3.getSize() << " tuumaa, " << objWheel3.getType() << "\n"
              << "  Rengas 4: " << objWheel4.getSize() << " tuumaa, " << objWheel4.getType() << "\n";
}
